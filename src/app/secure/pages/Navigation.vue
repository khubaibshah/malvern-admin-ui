    ...
    <div class="min-h-screen flex relative lg:static surface-ground">
        <div id="app-sidebar-5"
            ...
            <div class="flex flex-column h-full">
                <div class="flex align-items-center justify-content-center flex-shrink-0 bg-white"
                    style="height: 60px">
                    <img src="/src/assets/img/newlogo1.png" alt="Image" style="width: 6rem;
    height: 6rem;">
                ...
                <div class="mt-3">
                    <ul class="list-none p-3 m-0">
                        ...
                        <li>
                            <a @click="router.push({ name: 'scs-car-listings' })" v-ripple
                                class="flex flex-row lg:flex-column align-items-center cursor-pointer p-3 lg:justify-content-center hover:bg-gray-800 border-round text-gray-300 hover:text-white transition-duration-150 transition-colors p-ripple">
                                <i class="pi pi-list mr-2 lg:mr-0 mb-0 lg:mb-2 text-base lg:text-lg"></i>
                                <span class="text-center font-medium inline text-base lg:text-xs lg:block">Car
                                    list</span>
                            </a>
                        </li>
                        <li>
                            <a @click="router.push({ name: 'scs' })" v-ripple
                                class="flex flex-row lg:flex-column align-items-center cursor-pointer p-3 lg:justify-content-center hover:bg-gray-800 border-round text-gray-300 hover:text-white transition-duration-150 transition-colors p-ripple">
                                <i class="pi pi-car mr-2 lg:mr-0 mb-0 lg:mb-2 text-base lg:text-lg"></i>
                                <span class="text-center font-medium inline text-base lg:text-xs lg:block">Add</span>
                            </a>
                        </li>
                        <li>
                            <a @click="router.push({ name: 'featured-vehicle' })" v-ripple
                                class="flex flex-row lg:flex-column align-items-center cursor-pointer p-3 lg:justify-content-center hover:bg-gray-800 border-round text-gray-300 hover:text-white transition-duration-150 transition-colors p-ripple">
                                <i class="pi pi-image mr-2 lg:mr-0 mb-0 lg:mb-2 text-base lg:text-lg"></i>
                                <span class="text-center font-medium inline text-base lg:text-xs lg:block">Featured
                                </span>
                            </a>
                        </li>

                        <li>
                            <a @click="router.push({ name: 'archive-delete' })" v-ripple
                                class="flex flex-row lg:flex-column align-items-center cursor-pointer p-3 lg:justify-content-center hover:bg-gray-800 border-round text-gray-300 hover:text-white transition-duration-150 transition-colors p-ripple">
                                <i class="pi pi-trash mr-2 lg:mr-0 mb-0 lg:mb-2 text-base lg:text-lg"></i>
                                <span class="text-center font-medium inline text-base lg:text-xs lg:block">Archive
                                </span>
                            </a>
                        </li>
                        <li>
                            <a @click="router.push({ name: 'hpi-report' })" v-ripple
                                class="flex flex-row lg:flex-column align-items-center cursor-pointer p-3 lg:justify-content-center hover:bg-gray-800 border-round text-gray-300 hover:text-white transition-duration-150 transition-colors p-ripple">
                                <i class="pi pi-file mr-2 lg:mr-0 mb-0 lg:mb-2 text-base lg:text-lg"></i>
                                <span class="text-center font-medium inline text-base lg:text-xs lg:block">Hpi Report
                                </span>
                            </a>
                        </li>
                ...
                <ul
                    ...
                    <li>
                        <a @click="logout" v-ripple
                            class="flex p-3 lg:px-3 lg:py-2 align-items-center text-600 hover:text-900 hover:surface-100 font-medium border-round cursor-pointer transition-duration-150 transition-colors p-ripple">
                            <i class="pi pi-power-off text-base lg:text-2xl mr-2 lg:mr-0"></i>
